            ...
            <div className='py-22 flex flex-col items-center gap-10'>
                ...
                <section className="bg-gray-800 rounded-lg border border-black/10 dark:border-white/10  w-[70%]">
                    <div className="p-4 sm:p-6 border-b border-black/10 dark:border-white/10">
                        <h3 className="text-black dark:text-white text-lg font-bold leading-tight ">User Details</h3>
                    </div>
                    <div className="p-4 sm:p-6">
                        <div className="flex justify-between gap-x-6 py-3 border-b border-black/10 dark:border-white/10">
                            <p className="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">Name</p>
                            <p className="text-black dark:text-white text-sm font-normal leading-normal text-right">{name}</p>
                        </div>
                        <div className="flex justify-between gap-x-6 py-3 border-b border-black/10 dark:border-white/10">
                            <p className="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">Email</p>
                            <p className="text-black dark:text-white text-sm font-normal leading-normal text-right">{email}</p>
                        </div>
                        <div className="flex justify-between gap-x-6 py-3">
                            <p className="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">Phone Number</p>
                            <p className="text-black dark:text-white text-sm font-normal leading-normal text-right">+91 {phoneNo}</p>
                        </div>
                    </div>
                </section>
                <section className="bg-gray-800 rounded-lg border border-black/10 dark:border-white/10 w-[70%]">
                ...
                <section className="bg-gray-800 rounded-lg border border-black/10 dark:border-white/10 w-[70%]">
                    <div className="p-4 sm:p-6 border-b border-black/10 dark:border-white/10">
                        <h3 className="text-black dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Actions</h3>
                    </div>
                    <div className="p-4 sm:p-6 flex flex-col gap-4">
                        <div className="flex items-center gap-4 min-h-14 justify-between">
                            <div className="flex items-center gap-4">
                                <LogoutIcon sx={{color:'red'}}/>
                                <p className="text-black dark:text-white text-base font-normal leading-normal flex-1 truncate">Sign out of all devices</p>
                            </div>
                        ...
                        <div className="flex items-center gap-4 min-h-14 justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-black dark:text-white text-base font-normal leading-normal flex-1 truncate">Delete Account</p>
                            </div>
                            <div className="shrink-0">
