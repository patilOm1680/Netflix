...
function HeroCarsouel({ topicName, movies }) {
        ...
        <div className="relative group">
          ...
          >
            {movies.map((movie, index) => (
              <SpecialCard movie={movie} index={index} hoveredIndex={hoveredIndex} setHoveredIndex={setHoveredIndex} />
